...
const translations = {
    ...
    'zh': {
        ...
        'nav.contact': '联系我们',
        'nav.portal': '客戶登入',
        'hero.title': 'Easy Hong Kong Company Formation, Guaranteed',
        'hero.subtitle': 'AIcountant 提供专业香港公司注册及会计服务，助您轻松开启商业之旅。简单、快速、有保障。',
        'hero.cta': '查看服务',
    ...
    'en': {
        ...
        'hero.title': 'Easy Hong Kong Company Formation, Guaranteed',
        'hero.subtitle': 'AIcountant provides professional company formation and accounting services for your Hong Kong business. Simple, fast, and guaranteed.',
    ...
    'zh-TW': {
        ...
        'nav.portal': '客戶登入',
        'hero.title': 'Easy Hong Kong Company Formation, Guaranteed',
        'hero.subtitle': 'AIcountant 提供專業香港公司註冊及會計服務，助您輕鬆開啟商業之旅。簡單、快速、有保障。',
        'hero.cta': '查看服務',
